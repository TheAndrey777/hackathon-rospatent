    ...
    public class HttpApiClient
    {
        ...
        public static async Task<Rospatent.SearchResponse> Search(String query, int limit, int page)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                Rospatent.SearchResponse? deserializedResponse = JsonSerializer.Deserialize<Rospatent.SearchResponse>(responseContent);
        ...
        public static async Task<Rospatent.Document> GetDocument(String id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                Rospatent.Document? deserializedResponse = JsonSerializer.Deserialize<Rospatent.Document>(responseContent);
                return deserializedResponse;
            }
            return null;
        }
